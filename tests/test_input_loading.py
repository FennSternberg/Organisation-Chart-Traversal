...
class TestInputLoading(unittest.TestCase):
    ...
    def test_missing_employee_id(self):
        ...
        self.assertEqual(len(org.employees), 7)
        ...
        self.assertEqual(org.employees[6].name_normalized, "black widow")
        self.assertEqual(org.employees[6].manager_id, 2)
        self.assertEqual(org.get_children(6), [16])
...
class TestInputLoadingError(unittest.TestCase):
    """Tests for input loading that should cause errors."""
